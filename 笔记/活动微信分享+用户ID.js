						    	...
						    	if(json.error == -1){
									...
									wx.ready(function () {   
										...
										wx.onMenuShareTimeline({
										    title: '您的好友给您送来一个新年大红包，快来开个“旺”运吧。', // 分享标题
										    link: 'http://wx.xgqq.com/#activity/chest?invite='+activeidss+'', // 分享链接
										    imgUrl: 'http://wx.xgqq.com/static/img/chest/share.jpg', // 分享图标
										    success: function () { 
										...
										wx.onMenuShareAppMessage({
                                            ...
                                            desc: '您的好友给您送来一个新年大红包，快来开个“旺”运吧。', // 分享描述
										    link: 'http://wx.xgqq.com/#activity/chest?invite='+activeidss+'', // 分享链接
										    imgUrl: 'http://wx.xgqq.com/static/img/chest/share.jpg', // 分享图标
										    success: function () { 
