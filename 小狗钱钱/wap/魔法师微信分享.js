           		...
           		_this.setXHR("weixin/sigin", function(){
					...
					wx.ready(function () { 
						...
						wx.onMenuShareTimeline({
						    title: '小狗钱钱-金钱魔法师 第二期 丰厚奖金等你瓜分', // 分享标题
						    link: 'http://wx.xgqq.com/#activity/moneyMagiciantwo', // 分享链接
						    imgUrl: 'http://wx.xgqq.com/static/img/magiciantwo/wx_mf2.png', // 分享图标
						    success: function () { 
						        // 用户确认分享后执行的回调函数
									...
									window.location.href="http://wx.xgqq.com/#user/invest";
						    },
